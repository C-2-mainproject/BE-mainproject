package com.wolves.mainproject.config.async;

import com.wolves.mainproject.exception.AsyncExceptionHandler;
...
public class AsyncConfig implements AsyncConfigurer {
    ...
    //Queue 수
    private static int TASK_QUEUE_CAPACITY = Integer.MAX_VALUE;
    //Thread Bean Name
